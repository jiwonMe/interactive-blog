...
<Section>
  ...
  **직접 체험해보세요:**
  ...
  - 오른쪽 하단의 **명령 히스토리**에서 실행한 모든 명령을 확인할 수 있습니다. 히스토리 항목을 클릭하면 해당 시점의 상태로 **시간 여행**을 할 수 있습니다.
...
```
  ...
  오른쪽의 히스토리 컴포넌트는 명령이 실행될 때마다 스택에 쌓이는 모습을 보여줍니다. "불 켜기"나 "불 끄기" 버튼을 누르면 히스토리에 명령이 추가되는 것을 실시간으로 확인할 수 있습니다.
